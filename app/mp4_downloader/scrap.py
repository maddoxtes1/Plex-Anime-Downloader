...
def sibnet_scrap(url, logger=None):
    if logger is None:
...
def vidmoly_scrap(url, segmentation_path, logger=None):
    if logger is None:
...
def oneupload_scrap(url, segmentation_path, logger=None):
    if logger is None:
...
def sendvid_scrap(url, logger=None):
    if logger is None:
